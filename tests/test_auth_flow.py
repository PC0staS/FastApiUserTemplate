...
from fastapiusertemplate.database import engine
...
def test_complete_user_flow(client):
    ...
    print("✅ Login exitoso: cookies establecidas")
    ...
    print("✅ Acceso a perfil con cookies: {profile_data['username']}")
    ...
    print("✅ Acceso funciona después del refresh")
    ...
    print("✅ Acceso denegado después del logout")
